...
public class Achievements {
    ...
    public Achievements() {
        Achievement ach1 = new Achievement("Getting the hang of it", "Scouted 2 matches in a row", 40);
        ach1.addRule(new RuleNumMatches(2));
        achievement_list.add(ach1);

        Achievement ach2 = new Achievement("Know thyself", "You just scouted team " + Globals.CurrentScoutingTeam, 20);
        ach2.addRule(new RuleTeamScouted(Globals.CurrentScoutingTeam));
        achievement_list.add(ach2);

        Achievement ach3 = new Achievement("Sore in the saddle", "Scouted for 30 minutes non-stop", 30);
        ach3.addRule(new RuleTimeScouting(1_800_000)); // 30 minutes
        achievement_list.add(ach3);

        Achievement ach4 = new Achievement("Master scouter", "Scouted 15 matches in a row", 100);
        ach4.addRule(new RuleNumMatches(15));
        achievement_list.add(ach4);

        Achievement ach5 = new Achievement("Calloused fingers", "Entered 300 events", 75);
        ach5.addRule(new RuleNumEvents(300));
        achievement_list.add(ach5);

        Achievement ach6 = new Achievement("Orphan Annie", "You left an event incomplete (orphan)", 5);
        ach6.addRule(new RuleOrphanEvents(1, true));
        achievement_list.add(ach6);

        Achievement ach7 = new Achievement("Orphanage", "You left 10 events incomplete (orphan)", 15);
    ...
    public static ArrayList<PoppedAchievement> popAchievements() {
        ...
        for (Achievement a : achievement_list) {
            ...
            if (a.met && !a.popped) {
                ...
                ret.add(new PoppedAchievement(a.reward + " - " + a.title, a.description));
            }
        }
    ...
    // =============================================================================================
     public static class Achievement {
        ...
        private Achievement(String in_title, String in_description, int in_reward) {
            title = in_title;
    ...
    public static class PoppedAchievement {
        ...
        public PoppedAchievement(String in_title, String in_description) {
            title = in_title;
            description = in_description;
        }
    }
